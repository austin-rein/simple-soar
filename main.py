...
async def scan_ip_address(report: ThreatReport):
    ...
    return {
        ...
        "av_verdict": av_results.get('verdict', {"error": av_results.get("error", "Data unavailable")}),
        "av_context": av_results.get('context', {"error": av_results.get("error", "Data unavailable")})
    }
...
#        "av_verdict": av_results['verdict'],
#        "av_context": av_results['context']
#    }
